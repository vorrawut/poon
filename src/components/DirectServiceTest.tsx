    ...
    <div className="bg-purple-100 border border-purple-400 rounded-lg p-4 mb-4">
      ...
      <div className="space-y-2 text-sm">
        ...
        {testResults.netWorth && (
          <div className={`p-2 rounded ${testResults.netWorth.success ? 'bg-green-100' : 'bg-red-100'}`}>
            <strong>NetWorth:</strong> 
            {testResults.netWorth.success ? (
              <>
                ✅ Success - ${testResults.netWorth.totalNetWorth?.toLocaleString()} 
        ...
        {testResults.accounts && (
          <div className={`p-2 rounded ${testResults.accounts.success ? 'bg-green-100' : 'bg-red-100'}`}>
