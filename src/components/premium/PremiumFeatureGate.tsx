        ...
        <div className="text-center max-w-md mx-auto">
          ...
          <div className="mb-6">
            <div className="flex items-center justify-center gap-2 mb-2">
              <LockClosedIcon
                className={`h-5 w-5 ${isPlayMode ? "text-yellow-300" : "text-amber-500"}`}
              />
              <AccessibleText
          ...
          >
            ...
            <ul className="space-y-1 text-sm">
              <li
                className={`flex items-center gap-2 ${isPlayMode ? "text-blue-100" : "text-gray-600"}`}
              >
                <span
                  className={isPlayMode ? "text-green-300" : "text-green-500"}
                >
                  ✓
                </span>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <AccessibleButton
              ...
              className={
                isPlayMode
                  ? "text-blue-100 hover:bg-white/10 border-white/30"
                  : "text-gray-600"
              }
            >
