      ...
      <div className="relative">
        ...
        <div className={`relative rounded-lg border-2 overflow-hidden ${
          ...
          >
            ...
            <defs>
              <linearGradient id="areaGradient" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" stopColor={performance >= 0 ? "#10B981" : "#EF4444"} stopOpacity="0.3" />
                <stop offset="100%" stopColor={performance >= 0 ? "#10B981" : "#EF4444"} stopOpacity="0.05" />
              </linearGradient>
              <linearGradient id="lineGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor={performance >= 0 ? "#10B981" : "#EF4444"} />
                <stop offset="50%" stopColor={performance >= 0 ? "#059669" : "#DC2626"} />
                <stop offset="100%" stopColor={performance >= 0 ? "#10B981" : "#EF4444"} />
              </linearGradient>
            </defs>
            ...
            {data.map((_, i) => (
              <line
                ...
                y2="200"
                stroke={viewMode === "play" ? "rgba(255,255,255,0.05)" : "rgba(0,0,0,0.05)"}
                strokeWidth="1"
              />
            ))}
          ...
          <div className="absolute bottom-4 left-4">
            <div className={`text-xs ${viewMode === "play" ? "text-white/60" : "text-gray-500"}`}>
        ...
        <div className="flex justify-center mt-4 space-x-6">
          <div className="flex items-center gap-2">
            <div className={`w-3 h-3 rounded-full ${performance >= 0 ? "bg-green-400" : "bg-red-400"}`}></div>
            <span className={`text-sm ${viewMode === "play" ? "text-white/70" : "text-gray-600"}`}>
              Portfolio Value
            </span>
          </div>
          <div className="flex items-center gap-2">
