        ...
        <div className="absolute inset-0 pointer-events-none">
          {Array.from({ length: 20 }).map((_, i) => (
            <FlowParticle
              ...
              delay={i * 0.3}
              color={
                incomeStreams[i % incomeStreams.length]?.color || "#10B981"
              }
              direction="down"
            />
          ))}
          {Array.from({ length: 15 }).map((_, i) => (
            <FlowParticle
              ...
              delay={i * 0.4 + 1}
              color={
                spendingCategories[i % spendingCategories.length]?.color ||
                "#EF4444"
              }
              direction="down"
            />
          ...
          {incomeStreams.map((stream, index) => (
            ...
            >
              <div className="text-center">
                ...
                <div
                  className={`text-sm font-medium mb-1 ${viewMode === "play" ? "text-white" : "text-gray-900"}`}
                >
                  {stream.name}
                </div>
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20">
        ...
        >
          <div className="text-center min-w-[200px]">
            ...
            <div
              className={`text-sm font-medium mb-2 ${viewMode === "play" ? "text-white" : "text-gray-900"}`}
            >
              Net Balance
            </div>
            <div
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span
                        className={`font-medium ${viewMode === "play" ? "text-white" : "text-gray-900"}`}
                      >
