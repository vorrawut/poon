...
import { DevicePhoneMobileIcon, XMarkIcon, SparklesIcon } from '@heroicons/react/24/outline';
...
export function PWAInstallPrompt() {
  ...
  useEffect(() => {
    const handleBeforeInstallPrompt = (e: Event) => {
      ...
      if (!installDismissed || (lastPromptTime && now - parseInt(lastPromptTime) > dayInMs * 7)) {
      ...
      >
        <AccessibleButton
          ...
          className={`absolute top-2 right-2 ${
            isPlayMode ? 'text-white hover:bg-white/10' : 'text-gray-400 hover:bg-gray-100'
          }`}
          ...
          <div className="flex-1">
            ...
            <div className="flex gap-2 mt-4">
              <AccessibleButton
                ...
                className={isPlayMode ? 'bg-white/20 text-white hover:bg-white/30 border-white/30' : ''}
              >
              ...
              <AccessibleButton
                ...
                size="sm"
                onClick={handleDismiss}
                className={isPlayMode ? 'text-blue-100 hover:bg-white/10' : 'text-gray-600 hover:bg-gray-100'}
              >
                {t('pwa.install.later')}
              </AccessibleButton>
            </div>
