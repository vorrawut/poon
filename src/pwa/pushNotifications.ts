  ...
  async showNotification(payload: NotificationPayload): Promise<void> {
    try {
      ...
      const options: NotificationOptions = {
        ...
        // actions: payload.actions || template.actions, // Not supported in all browsers
        tag: payload.tag || payload.type,
        requireInteraction:
          payload.requireInteraction ?? template.requireInteraction,
        silent: payload.silent || false,
        // timestamp: payload.timestamp // Not supported in NotificationOptions
      };
