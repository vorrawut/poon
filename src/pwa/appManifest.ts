...
export function generateAppManifest(
  ...
  const manifest: AppManifest = {
    name: isThaiLanguage
      ? "Poon - แอปการเงินส่วนตัว"
      : "Poon - Personal Financial Growth",
    short_name: "Poon",
    ...
    lang: language,
    dir: "ltr",
    categories: ["finance", "productivity", "lifestyle", "education"],
    icons: [
      // Standard icons
      {
    ...
    shortcuts: [
      ...
      },
      {
        ...
        description: isThaiLanguage
          ? "สำรวจจักรวาลการเงินของคุณ"
          : "Explore your financial universe",
        url: "/universe",
        icons: [
          {
...
export class PWAInstallManager {
  ...
  private trackPWAInstallation(): void {
    ...
    // Example analytics call (if gtag is available)
