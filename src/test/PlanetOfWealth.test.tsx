...
describe('PlanetOfWealth Component', () => {
  ...
  describe('Visual States', () => {
    it('applies growing state classes for positive growth', () => {
      ...
      expect(container.querySelector('.border-emerald-400')).toBeInTheDocument();
  ...
  describe('Responsive Design', () => {
    it('applies responsive text classes', () => {
      ...
      expect(container.querySelector('.text-2xl.md\\:text-4xl')).toBeInTheDocument();
      expect(container.querySelector('.text-sm.md\\:text-lg')).toBeInTheDocument();
    });
  ...
  describe('Component Structure', () => {
    it('renders all essential elements', () => {
      ...
      expect(container.querySelector('.relative.flex.flex-col.items-center')).toBeInTheDocument();
