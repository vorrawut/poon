...
export class ThaiLocalizationService {
  ...
  formatCurrency(amount: number, language: 'en' | 'th' = 'en', compact: boolean = false): string {
...
export function formatThaiCurrency(amount: number, language: 'en' | 'th' = 'en', compact: boolean = false): string {
...
export function formatBuddhistDate(date: Date, language: 'en' | 'th' = 'en'): string {
