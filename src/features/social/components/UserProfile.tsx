  ...
  achievements: [
    {
      ...
      description: {
        en: "Completed your first savings goal",
        th: "ทำเป้าหมายการออมแรกสำเร็จ",
      },
      icon: "🎯",
      rarity: "common",
      category: "goals",
    ...
    },
    {
      ...
      description: {
        en: "Achieved 80+ cultural score",
        th: "ได้คะแนนวัฒนธรรม 80+ คะแนน",
      },
      icon: "🙏",
      rarity: "epic",
      category: "cultural",
    ...
    },
    {
      ...
      description: {
        en: "30-day logging streak",
        th: "บันทึกข้อมูลต่อเนื่อง 30 วัน",
      },
      icon: "🔥",
      rarity: "rare",
      category: "streak",
    ...
    },
    {
      ...
      description: {
        en: "Donated to temples 10 times",
        th: "บริจาควัด 10 ครั้ง",
      },
      icon: "🏛️",
      rarity: "rare",
      category: "cultural",
    ...
    },
    {
      ...
      description: {
        en: "Connected with 10 friends",
        th: "เชื่อมต่อกับเพื่อน 10 คน",
      },
      icon: "🦋",
      rarity: "common",
      category: "social",
    ...
    <div className="space-y-4">
      ...
      <div className="text-center">
        ...
        <div className="text-sm text-gray-400">
          ...
          {(stats.experience + stats.experienceToNext).toLocaleString()} XP
        </div>
      </div>
          ...
          <div className="flex items-center gap-2">
            {isOwnProfile ? (
              ...
              <>
                ...
                <ThemeAwareButton variant="ghost">💬 Message</ThemeAwareButton>
              </>
            )}
          </div>
        </div>
          ...
          {selectedTab === "activity" && (
            <ThemeAwareCard className="p-6 text-center">
              ...
              <ThemeAwareText color="secondary">
                Coming soon! Track your friends' financial achievements and
                milestones.
              </ThemeAwareText>
            </ThemeAwareCard>
          )}
