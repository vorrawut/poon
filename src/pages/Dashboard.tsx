...
export default function Dashboard() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-8">
      ...
      <FadeIn direction="down" delay={0.1} className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
      ...
      <AccountsOverviewWidget 
        onAccountAction={handleQuickAction}
      />
          ...
          <div className="bg-white rounded-xl shadow-card border border-gray-100 overflow-hidden">
            ...
            <div className="p-6">
              <div className="text-center py-12 text-gray-500">
                ...
                <p className="text-sm mt-2">This will be implemented in the Portfolio feature module</p>
              </div>
            </div>
          </div>
        </FadeIn>
          ...
          <div className="bg-white rounded-xl shadow-card border border-gray-100 overflow-hidden">
            ...
            <div className="p-6">
              <div className="text-center py-12 text-gray-500">
                ...
                <p className="text-sm mt-2">This will be implemented in the Analytics feature module</p>
              </div>
            </div>
          </div>
        </FadeIn>
